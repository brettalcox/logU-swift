...
class FrequencyViewController: UIViewController, UIActionSheetDelegate {
    
    let url_to_request:String = "https://loguapp.com/swift_frequency2.php"
    ...
    func loadAfter(object: Array<Dictionary<String, String>>) {
        ...
        for i in 0..<object.count {
            ...
            graphPoundage.append(Double(dataWeek[i]["frequency"]!)!)
        }
    ...
    func setLineChart(dataPoints: [String], values: [Double]) {
        ...
        if graphWeek.count == 0 || graphPoundage.count == 0 {
            ...
            let chartDataSet = LineChartDataSet(yVals: dataEntries, label: "Weekly Frequency")
